...
const Canada = () => {
  const data =[{
    ...
    header4:"Did you know Canada has not one but multiple pathways to enter and live in the country? This masterclass will help you plan your move & settle in Canada. It will help you wherever you are in your immigration journey.",
    time:"",
    hours:"2 hours",
    date:"",
    Enroll_link:"",
    ...
    header9:"Master your move to Canada!",
    header10:"This Masterclass is for YOU if you want to discover the ins and outs of life in Canada.",
    header11:"Students or a Working Professionals",
    subheader4:"If you're considering relocating to Canada but uncertain about the country's conditions, this masterclass is for you.",
    header12:"Destination Dilemma?",
    subheader5:"Unsure which country is the perfect fit for you? Join us to gain clarity on whether Canada aligns with your aspirations.",
    header13:"Future Residents",
    subheader6:"Planning to relocate to Canada, either now or in the future? Understand the immigration process and set yourself up for a successful transition with our expert advice.",
    ...
    ytlink:"https://www.youtube.com/watch?v=1Ch9tpOqfsQ",
    ...
    subheader11:"Get deeper information from 4 Mentors, each one of whom used a different pathway & get your queries answered.",
    ...
    subheader12:"Free Bonuses worth INR 20K will be revealed during the Masterclass to jumpstart your Canada move!",
    subheader13:"(Get course resources, resume template, list of 200+ recruiting agencies & much more!)",
    header23:"FAQs",
    question1:"How many mentors will be there in the session?",
    answer1:"There will be 5 experienced mentors, each of whom used a different pathway to move to Canada.",
