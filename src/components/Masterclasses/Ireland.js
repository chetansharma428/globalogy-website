...
const Ireland = () => {
  const data =[{
    ...
    header4:"This exclusive 2 hour Masterclass unlocks the secrets to a smooth move to Ireland! Explore visa options, craft winning job applications, secure sponsorships, and discover the charm of Irish life. Make your dream a reality!",
    time:"",
    hours:"",
    data:"",
    Enroll_link:"",
    ...
    header9:"Ready for an Irish Adventure?",
    header10:"This Masterclass is for YOU if you are looking for a vibrant life in Ireland.",
    header11:"Students or a Working Professionals",
    subheader4:"If you're considering relocating to the Netherlands but uncertain about the country's conditions, this masterclass is for you.",
    header12:"Destination Dilemma?",
    subheader5:"Unsure which country is the perfect fit for you? Join us to gain clarity on whether the Netherlands aligns with your aspirations.",
    header13:"Future Residents",
    subheader6:"Planning to relocate to the Netherlands, either now or in the future? Understand the immigration process and set yourself up for a successful transition with our expert advice.",
    ...
    ytlink:"https://www.youtube.com/watch?v=px4qMbGJhwI",
    ...
    subheader11:"Get deeper information from the Mentors from various industries who moved on sponsored visas & get your queries answered.",
    ...
    subheader12:"Free Bonuses worth INR 15K will be revealed during the Masterclass to jumpstart your move!",
    subheader13:"(Get course resources, resume template, list of 70+ recruiting agencies & much more!)",
    header23:"FAQs",
    question1:"How many mentors will be there in the session?",
    answer1:"There will be experienced mentors from diverse industries to share their journeys.",
