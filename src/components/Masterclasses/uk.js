...
const Uk = () => {
    const data =[{
        header1:"OFF-TO",
        header2:"UNITED KINGDOM! ✈️",
        header3:"with Nidhi Nagori",
        header4:"Unlock your British adventure with our exclusive 2 Hour Masterclass! Demystify the immigration process, secure visa sponsorships, craft flawless job applications, and discover how to thrive in your new home in the UK!",
        time:"",
        hours:"",
        Enroll_link:"",
        button1:"REGISTER NOW!",
        header5:"What’s In It For You?",
        header6:"Access to 150+ Job Portals",
        subheader1:"Get an exclusive list of 150+ job portals with over 100,00 active jobs.",
        header7:"3 Month Access",
        subheader2:"The recording of the Live session can be accessed for 3 months from the date of sign-up.",
        header8:"Networking Forum",
        subheader3:"Get a platform to network with like minded individuals and learn & grow together.",
        header9:"Want to Live & Work in the UK?",
        header10:"This Masterclass is for YOU 🫵 if you are ready to take a leap and start a new life in the United Kingdom.",
        header11:"Students or a Working Professionals",
        subheader4:"If you're considering relocating to the UK but uncertain about the country's conditions, this masterclass is for you.",
        header12:"Destination Dilemma?",
        subheader5:"Unsure which country is the perfect fit for you? Join us to gain clarity on whether the UK aligns with your aspirations.",
        header13:"Future Residents",
        subheader6:"Planning to relocate to the UK, either now or in the future? Understand the immigration process and set yourself up for a successful transition with our expert advice.",
        ...
        ytlink:"https://youtu.be/ONVqDip3L5Q",
        ...
        subheader13:"(Get course resources, resume template, list of 150+ job portals & much more!)",
        header23:"FAQs",
        question1:"How many mentors will be there in the session?",
        answer1:"There will be experienced mentors from diverse industries who have themselves moved to the UK.",
