...
const Netherlands = () => {
  const data =[{
    ...
    header4:"An exclusive Masterclass for living & working in the Netherlands. Explore visa options, craft winning job applications, secure sponsorships, and discover the ins and outs of Dutch life. This 2-day Masterclass unlocks the secrets to a smooth move to the Netherlands!",
    time:"",
    hours:"2 hours",
    date:"",
    Enroll_link:"",
    ...
    header9:"Ready to decode Dutch Life?",
    header10:"This Masterclass is for YOU 🫵 if you are looking for pathways to Live & Work in Netherlands.",
    ...
    ytlink:"https://youtu.be/-IS6wQvqQt8",
    ...
    subheader11:"Get deeper information from 3 Mentors from various industries & get your queries answered.",
    ...
    answer1:"There will be 3 experienced mentors from diverse industries to share their journeys.",
