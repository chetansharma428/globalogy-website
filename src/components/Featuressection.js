  ...
  return (
    <div class="container">
      <div class="row d-flex flex-wrap align-items-center g-2 gap-4 py-4">
        <div class="mid col-lg-6 col-sm-12 position-relative">
          <div class="corner-content top-left glow">
            <img src={rocket} class="img-fluid" alt="" />
          </div>
          <div class="row justify-content-center align-items-center g-2 d-flex flex-column gap-2">
            <div class="col">
        ...
        <div class="mid col position-relative">
          <div class="corner-content top-right glow">
            <img src={arrow} class="img-fluid" alt="" />
          </div>
          <div class="row justify-content-center align-items-center g-2 d-flex flex-column gap-4">
            <div class="col">
              <div class="row justify-content-center align-items-center g-2 d-flex flex-column ">
                <div class="col icon">
